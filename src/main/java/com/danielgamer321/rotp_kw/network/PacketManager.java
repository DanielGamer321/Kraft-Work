package com.danielgamer321.rotp_kw.network;

import com.danielgamer321.rotp_kw.RotpKraftWorkAddon;
import com.danielgamer321.rotp_kw.network.packets.fromserver.*;
...
public class PacketManager {
    ...
    public static void init() {
        channel = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(RotpKraftWorkAddon.MOD_ID, "main_channel"))
